...
// version 6 adds support for vendor_ab and recovery_ab, remove htcdumlock, Unmap Super Devices for A-only devices
// version 7 adds ORS confirmation prompt
#define TW_THEME_VERSION 7
