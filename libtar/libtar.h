...
static inline void* get_policy(fscrypt_policy *p) { return p; }
static inline size_t fscrypt_policy_size(fscrypt_policy *p) { (void)p; return sizeof(struct fscrypt_policy_v1); }
static inline void* get_policy_descriptor(fscrypt_policy *p) { return p ? (void*)p->master_key_descriptor : NULL; }
