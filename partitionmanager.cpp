...
void inline RESET(std::string prop, std::string def, TWPartition *ven, TWPartition *odm) {
	if (odm) TWFunc::Property_Override(prop, TWFunc::Partition_Property_Get(prop, PartitionManager, "/odm", "build.prop"));
