...
void DataManager::SetDefaultValues()
{
	...
	mData.SetValue(TW_SETTINGS_FILE_VAR, DataManager::GetSettingsFileName());
...
void DataManager::LoadTWRP_FolderInfo(){
	...
	SetValue(TW_SETTINGS_FILE_VAR, GetSettingsFileName());
	mBackingFile = mainPath + GetStrValue(TW_MAIN_FOLDER_VAR) + '/' + GetStrValue(TW_SETTINGS_FILE_VAR);
}

string DataManager::GenarateSettingsFileName(){
...
string DataManager::GetSettingsFileName(){
	string TWRPFolderPath = GetSettingsStoragePath() + DataManager::GetStrValue(TW_MAIN_FOLDER_VAR);
	string str = GenarateSettingsFileName();
	return TWFunc::Path_Exists(TWRPFolderPath + "/" + str) ? str : ".twrps";
}