...
ifneq ($(TW_EXCLUDE_TZDATA), true)
    ...
    ifeq ($(BOARD_BUILD_SYSTEM_ROOT_IMAGE),true)
        LOCAL_POST_INSTALL_CMD += \
            mkdir -p $(TARGET_ROOT_OUT)/system_root/system/usr/share/zoneinfo; \
            cp -f $(TARGET_OUT)/usr/share/zoneinfo/tzdata $(TARGET_ROOT_OUT)/system_root/system/usr/share/zoneinfo/;
    else
        LOCAL_POST_INSTALL_CMD += \
            mkdir -p $(TARGET_ROOT_OUT)/system/usr/share/zoneinfo; \
            cp -f $(TARGET_OUT)/usr/share/zoneinfo/tzdata $(TARGET_ROOT_OUT)/system/usr/share/zoneinfo/;
    endif
