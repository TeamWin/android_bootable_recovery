...
bool Decrypt_User_Synth_Pass(const userid_t user_id, const std::string& Password) {
	...
	// int flags = android::os::IVold::STORAGE_FLAG_DE;
    // if (user_id == 0)
	// 	flags = android::os::IVold::STORAGE_FLAG_DE;
	// else
	// 	flags = android::os::IVold::STORAGE_FLAG_CE;
	...
	printf("running fscrypt_prepare_user_storage for CE keys\n");
