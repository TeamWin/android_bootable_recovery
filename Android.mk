...
ifneq ($(BOARD_GOOGLE_DYNAMIC_PARTITIONS_PARTITION_LIST),)
	LOCAL_CFLAGS += "-DDYNAMIC_PARTITIONS_PARTITION_LIST=\"$(shell echo $(BOARD_GOOGLE_DYNAMIC_PARTITIONS_PARTITION_LIST) | sed -r 's/\b(.)/\u\1/g' | sed -e 's/ \+/, /g')\""
endif

ifneq ($(BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST),)
	LOCAL_CFLAGS += "-DDYNAMIC_PARTITIONS_PARTITION_LIST=\"$(shell echo $(BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST) | sed -r 's/\b(.)/\u\1/g' | sed -e 's/ \+/, /g')\""
endif
