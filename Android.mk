...
ifeq ($(AB_OTA_UPDATER),true)
    ...
    LOCAL_SHARED_LIBRARIES += libhardware android.hardware.boot@1.1
    # android.hardware.boot@1.0
    TWRP_REQUIRED_MODULES += libhardware android.hardware.boot@1.1-service android.hardware.boot@1.1-service.rc \
        android.hardware.boot@1.1.xml
    # android.hardware.boot@1.0-service android.hardware.boot@1.0-service.rc
endif
