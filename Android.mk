...
ifeq ($(AB_OTA_UPDATER),true)
    ...
    LOCAL_C_INCLUDES += system/core/fs_mgr/libsnapshot/include
    LOCAL_SHARED_LIBRARIES += libhardware android.hardware.boot@1.0 android.hardware.boot@1.1 libprotobuf-cpp-lite
    LOCAL_STATIC_LIBRARIES += libsnapshot_nobinder libhidlbase libutils liblog libfs_mgr liblp libfec libsquashfs_utils \
        libcrypto_utils libfec_rs
