...
void surface_ROTATION_transform(GRSurface* dst_ptr, const GRSurface* src_ptr, size_t num_bytes_per_pixel);
...
// functions.
void res_free_surface(std::unique_ptr<GRSurface> surface);
