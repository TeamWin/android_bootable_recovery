...
string TWFunc::Check_For_TwrpFolder(){
	...
	if(oldFolder == "" && customTWRPFolders.empty()){
		...
		if(Path_Exists(mainPath + TW_DEFAULT_FOLDER)){
			string oldBackupFolder = mainPath + TW_DEFAULT_FOLDER + "/BACKUPS/" + DataManager::GetStrValue("device_id");
			...
			Exec_Cmd("rm -rf \"" + mainPath + TW_DEFAULT_FOLDER + '\"');
		}
